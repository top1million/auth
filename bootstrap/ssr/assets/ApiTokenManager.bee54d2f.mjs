...
import { _ as _sfc_main$8, a as _sfc_main$9 } from "./DialogModal.afa01af9.mjs";
import { _ as _sfc_main$7 } from "./Button.175f8d18.mjs";
import { _ as _sfc_main$b } from "./ConfirmationModal.306cb26b.mjs";
import { _ as _sfc_main$c } from "./DangerButton.58b8facf.mjs";
import { _ as _sfc_main$1 } from "./FormSection.4db81788.mjs";
import { _ as _sfc_main$3 } from "./Input.6700974d.mjs";
import { _ as _sfc_main$5 } from "./Checkbox.2c1d8116.mjs";
import { _ as _sfc_main$4 } from "./InputError.5e8397a2.mjs";
import { _ as _sfc_main$2 } from "./Label.fd16ae4b.mjs";
import { _ as _sfc_main$a } from "./SecondaryButton.a73b96bc.mjs";
import { J as JetSectionBorder } from "./SectionBorder.db4c3026.mjs";
          ...
          if (_push2) {
            ...
            if (__props.availablePermissions.length > 0) {
              ...
              ssrRenderList(__props.availablePermissions, (permission) => {
                ...
                _push2(`<span class="ml-2 text-sm text-gray-600 dark:text-gray-200"${_scopeId}>${ssrInterpolate(permission)}</span></label></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.availablePermissions, (permission) => {
                    return openBlock(), createBlock("div", { key: permission }, [
                      createVNode("label", { class: "flex items-center" }, [
                        ...
                        createVNode("span", { class: "ml-2 text-sm text-gray-600 dark:text-gray-200" }, toDisplayString(permission), 1)
                      ])
                    ]);
                  }), 128))
                ])
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.jetstream.flash.token) {
              _push2(`<div class="mt-4 bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded font-mono text-sm text-gray-500 dark:text-slate-500"${_scopeId}>${ssrInterpolate(_ctx.$page.props.jetstream.flash.token)}</div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              _ctx.$page.props.jetstream.flash.token ? (openBlock(), createBlock("div", {
                key: 0,
                class: "mt-4 bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded font-mono text-sm text-gray-500 dark:text-slate-500"
