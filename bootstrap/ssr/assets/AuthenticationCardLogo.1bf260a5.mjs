import { resolveComponent, unref, mergeProps, withCtx, createTextVNode, createVNode, openBlock, createBlock, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), mergeProps({ href: "/" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="100" height="75" viewBox="0 0 100 75" version="1.1" id="svg21" sodipodi:docname="final-webauthn-logo-logo-color.svg" inkscape:version="0.92.4 (5da689c313, 2019-01-14)"${_scopeId}><metadata id="metadata25"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_rdf58RDF, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_cc58Work, { "rdf:about": "" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_dc58format, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`image/svg+xml`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(_component_dc58type, { "rdf:resource": "http://purl.org/dc/dcmitype/StillImage" }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_dc58title, null, null, _parent4, _scopeId3));
                      } else {
                        return [
            ...
            _push2(`</metadata>`);
            _push2(ssrRenderComponent(_component_sodipodi58namedview, {
              pagecolor: "#ffffff",
              bordercolor: "#666666",
              borderopacity: "1",
              objecttolerance: "10",
            ...
            return [
              (openBlock(), createBlock("svg", {
                ...
                createVNode("metadata", { id: "metadata25" }, [
                  createVNode(_component_rdf58RDF, null, {
                    default: withCtx(() => [
                      createVNode(_component_cc58Work, { "rdf:about": "" }, {
                        default: withCtx(() => [
                          createVNode(_component_dc58format, null, {
                ...
                createVNode(_component_sodipodi58namedview, {
                  pagecolor: "#ffffff",
                  bordercolor: "#666666",
                  borderopacity: "1",
                  objecttolerance: "10",
                ...
                createVNode("defs", { id: "defs5" }, [
                  createVNode("clipPath", { id: "clip-logo-color" }, [
                    createVNode("rect", {
                      width: "1046",
                      height: "782",
                      id: "rect2",
