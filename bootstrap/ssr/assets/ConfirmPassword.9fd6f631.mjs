    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(JetAuthenticationCard, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mb-4 text-sm text-gray-600 dark:text-gray-200"${_scopeId}> This is a secure area of the application. Please confirm your password before continuing. </div>`);
            ...
            return [
              createVNode("div", { class: "mb-4 text-sm text-gray-600 dark:text-gray-200" }, " This is a secure area of the application. Please confirm your password before continuing. "),
