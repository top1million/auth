...
import { _ as _sfc_main$1, a as _sfc_main$3 } from "./DialogModal.afa01af9.mjs";
import { _ as _sfc_main$2 } from "./DangerButton.58b8facf.mjs";
import { _ as _sfc_main$4 } from "./Input.6700974d.mjs";
import { _ as _sfc_main$5 } from "./InputError.5e8397a2.mjs";
import { _ as _sfc_main$6 } from "./SecondaryButton.a73b96bc.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-w-xl text-sm text-gray-600 dark:text-gray-200"${_scopeId}> Once your account is deleted, all of its resources and data will be permanently deleted. Before deleting your account, please download any data or information that you wish to retain. </div><div class="mt-5"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "max-w-xl text-sm text-gray-600 dark:text-gray-200" }, " Once your account is deleted, all of its resources and data will be permanently deleted. Before deleting your account, please download any data or information that you wish to retain. "),
