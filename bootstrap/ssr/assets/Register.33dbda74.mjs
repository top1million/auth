              ...
              _push2(ssrRenderComponent(_sfc_main$3, { for: "terms" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="ml-2"${_scopeId2}> I agree to the <a target="_blank"${ssrRenderAttr("href", _ctx.route("terms.show"))} class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 hover:dark:text-slate-100"${_scopeId2}>Terms of Service</a> and <a target="_blank"${ssrRenderAttr("href", _ctx.route("policy.show"))} class="underline text-sm text-gray-600 hover:text-gray-900 dark:text-slate-100"${_scopeId2}>Privacy Policy</a></div></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "flex items-center" }, [
                        ...
                        createVNode("div", { class: "ml-2" }, [
                          ...
                          createVNode("a", {
                            ...
                            class: "underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 hover:dark:text-slate-100"
